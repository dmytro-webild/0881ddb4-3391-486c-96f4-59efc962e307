...
export default function LandingPage() {
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        { id: "m1", value: "94%", description: "Signal Accuracy" },
        { id: "m2", value: "24/7", description: "Market Monitoring" },
        { id: "m3", value: "15ms", description: "Latency" },
        { id: "m4", value: "50K+", description: "Active Traders" },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      useInvertedBackground={false}
      faqs={[
        { id: "f1", title: "How do I upload charts?", content: "Simply screenshot your TradingView chart and upload it via the dashboard." },
        { id: "f2", title: "Which markets are supported?", content: "We support Forex, Crypto, and major Indices." },
        { id: "f3", title: "Is the analysis automated?", content: "Yes, our engine processes the visual data in milliseconds." },
      ]}
